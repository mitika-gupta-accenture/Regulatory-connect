  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (selectedUser) {
      const params: UserDetailsParams = {
        ...
        newWebUserAccountStatusName: 'Enabled',
      };

      try {
        await updateUserStatus(params, 'Enabled');
          ...
          <GridCol className="two-thirds">
            <div id="main-content" className="govuk-!-margin-top-4">
              ...
              <h1 className="govuk-heading-xl">
                Confirm you want to enable this user{' '}
                <span className="govuk-caption-m govuk-!-margin-top-2">
                  {selectedUser?.organisationName}
                </span>
              </h1>
              <p className="govuk-body">
                Enabling this user will provide access to the product or
                service.
              </p>
                ...
                <tbody className="govuk-table__body">
                  <tr className="govuk-table__row">
                    ...
                    <td className="govuk-table__cell">
                      <span className="govuk-tag govuk-tag--green">Enable</span>
                    </td>
                  </tr>
