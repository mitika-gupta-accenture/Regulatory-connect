...
const Header = ({ withSignOut }: { withSignOut: boolean }) => {
  ...
  function signOut() {
    void (session.clear().then(() => 
      ...
      // note: Cannot use router at this point as it is not mounted
  ...
  return (
    <>
      <Head>
        <title>RegulatoryConnect</title>
      </Head>
      <meta charSet="utf-8" />
      <meta name="description" content="RegulatoryConnect" />
        ...
        <div className="govuk-header__container govuk-width-container">
          ...
          <div className="govuk-header__content">
            <a
              ...
              id="regulatory-connect-heading"
            >
              RegulatoryConnect
            </a>
            {withSignOut && (
              <nav className="sign-out-nav">
                {currentUser?.organisations && (
                  <a
                    href="/select-organisation"
                    className="govuk-link sign-out-nav__link"
                    id="regulatory-connect-heading"
                  >
                    Change organisation
                  </a>
